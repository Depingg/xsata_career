            ...
            <div className="mt-5 flex items-center gap-3">
              {[
                ...
                <a
                  ...
                  href="#"
                  aria-label={label}
                  className="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-border-light text-slate-500 transition-colors hover:border-primary hover:bg-accent hover:text-primary"
                >
